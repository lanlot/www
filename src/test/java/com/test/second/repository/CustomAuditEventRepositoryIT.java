...
import com.test.second.config.audit.AuditEventConverter;
import com.test.second.domain.PersistentAuditEvent;
...
import static com.test.second.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
